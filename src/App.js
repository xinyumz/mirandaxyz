    ...
    departments: [
      {
        ...
        supervisor: "Supervisor: Prof. Richard M. Laine",
        resumeItems: [
          {
      ...
      },
      {
        ...
        dates: ["Sep. 2020 - Apr. 2021", "Sep. 2018 - Dec. 2018"],
        positions: [{ title: "", date: "" }],
        supervisor: "",
        resumeItems: [],
      },
...
class Department extends React.Component {
  render() {
    return (
      <div>
        <h3 class="li-title container">{this.props.department.title}</h3>
        <div class="date">
          {this.props.department.dates.map((date, index) => (
            <div class="each-date" key={index}>
              {date}
            </div>
          ))}
        </div>
      ...
      <div class="list">
        <h3 class="li-title container">
          <span>
            ...
            <span class="nonbold">{this.props.experience.location}</span>
          </span>
        </h3>
